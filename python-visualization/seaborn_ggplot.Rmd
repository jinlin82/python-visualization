...
ggplot(mtcars,aes(x='wt',y='mpg')) + geom_point() +geom_abline(intercept=37,slope=-5,colour="red",size=10)#颜色存在问题
```
## geom_now_its_art
```{python}
...
p = ggplot(aes(x='x', y='y', color='abs(x - y)'), data=dsub.head(1000)) + geom_point() + scale_colour_gradient2(low="steelblue", high="black")

ggplot(aes(x='x', y='y', color='abs(x - y)'), data=dsub.head(1000)) + geom_point() + scale_colour_gradient2(low="yellow", high="red")
